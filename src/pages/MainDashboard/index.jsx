      ...
      <div className="bg-gray_100 flex sm:flex-col md:flex-col flex-row font-inter sm:gap-[20px] md:gap-[20px] items-start mx-[auto] pb-[30px] w-[100%]">
        <aside className="flex flex-col md:hidden justify-start md:px-[20px] w-[250px]">
          <div className="flex flex-col gap-[50px] items-center justify-start mb-[364px] mt-[30px] w-[100%]">
            <Img
              src={apiData?.status}
              className="common-pointer h-[40px] md:h-[auto] object-cover w-[65%]"
              onClick={() => navigate("/")}
              alt="Logo"
            />
            ...
            <div className="flex md:flex-col flex-row gap-[30px] items-center justify-between w-[100%]">
              <div className="flex md:flex-1 items-center justify-start md:w-[100%] w-[66%]">
                <div className="flex flex-col gap-[20px] items-center justify-start w-[100%]">
                  ...
                  <div className="flex md:flex-col flex-row gap-[30px] items-center justify-between w-[100%]">
                    <div className="bg-indigo_600 flex md:flex-1 flex-col gap-[33px] items-center justify-end pt-[24px] rounded-[25px] md:w-[100%] w-[48%]">
                    ...
                    <div className="bg-indigo_500 flex md:flex-1 flex-col gap-[33px] items-center justify-end pt-[24px] rounded-[25px] md:w-[100%] w-[48%]">
                      <div className="flex flex-col gap-[29px] items-start justify-start md:w-[100%] w-[87%]">
                        <div className="flex flex-row items-start justify-between w-[100%]">
                          <div className="flex flex-col items-start justify-start w-[auto]">
                            <Text
